...
# @Author : wufei
# @File : aspect_finetune_laptops.py
...
if __name__ == '__main__':
    config = {'mode': 'aspect_finetune', 'model': 'BERT', 'device': 0, 'data_path': 'data/laptops',
              ...
              'train_file': '/ISA/Data/laptops/Laptops_Train_v2_Implicit_Labeled_preprocess_finetune.pkl',
              'test_file': '/ISA/Data/laptops/laptop_test_enriched_preprocess_finetune.pkl',
              'num_workers_per_loader': 0,
              'seed': 42, 'batch_size': 32, 'dropout': 0.2, 'epoch': 6, 'warm_up': 70, 'label_smooth': 0.02,
              'optimizer': 'adamw', 'learning_rate': 6e-05, 'weight_decay': 0.015, 'grad_norm': 5.0,
              'checkpoint': '/ISA/Data/BERT_laptops.pt'}
